...
def parse_args(text: str, need_driver: bool = False):
    """
    Парсит аргументы вида: <год> <gp> <тип> [driver]
    """
    try:
...
async def add_user_cmd(message: types.Message):
    ...
    try:
        ...
        await message.answer(f"✅ User {user_id} добавлен.")
...
@dp.message(Command("position_changes"))
...
@dp.message(Command("driver_styling"))
